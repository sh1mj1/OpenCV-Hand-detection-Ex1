package com.example.opencvtest348;
...
import com.example.opencvtest348.databinding.ActivityMainBinding;
...
import com.example.opencvtest348.ColorBlobDetector;
...
//        System.loadLibrary("opencvtest348");
//    }
...
//        OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_3_1_0, this, mLoaderCallback);
        // ColorBlobDetectionActivity 에 있는 코드로 그대로 바꾸기
        if (!OpenCVLoader.initDebug()) {
...
//            OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_3_1_0, this, mLoaderCallback);
    ...
    public void onDestroy() {
        super.onDestroy();
//        mOpenCvCameraView.disableView(); // 변경
        if (mOpenCvCameraView != null)
            mOpenCvCameraView.disableView();
    }
